...
export const routes: Routes = [
    {
        path: '', component: MainLayoutComponent, children: [
            ...
            { path: 'products/:id', loadComponent: () => import('./features/pages/product-details/product-details.component.js').then((c) => c.ProductDetailsComponent), title: 'Product Details' },
        ]
    },
